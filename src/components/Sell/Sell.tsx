        ...
        {!livingSearch && (
          <>
            <div className='container_wrap'>
              <p>Выбирете из списка элемент, который хотите предложить</p>
              <input
                type='radio'
                id='collections'
              ...
              />
              <label htmlFor='collections'>коллекции</label>
              <input
                type='radio'
                id='buildings'
                name='chooseGroupSell'
              ...
              />
              <label htmlFor='buildings'>Здания</label>
              <input
                type='radio'
                id='materials'
                name='chooseGroupSell'
